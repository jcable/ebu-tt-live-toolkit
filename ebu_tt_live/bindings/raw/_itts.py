# ./ebu_tt_live/bindings/raw/_itts.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:3de6582874db8dbcce5075849f6c52f7eb30ed34
# Generated 2023-10-04 16:45:22.902980 by PyXB version 1.2.6 using Python 3.11.5.final.0
# Namespace http://www.w3.org/ns/ttml/profile/imsc1#styling [xmlns:itts]
...
Namespace = pyxb.namespace.NamespaceForURI('http://www.w3.org/ns/ttml/profile/imsc1#styling', create_if_missing=True)
...
class STD_ANON (pyxb.binding.datatypes.token, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/Users/cablej01/Projects/dazzler/ebu-tt-live-toolkit/ebu_tt_live/xsd/imsc1-styling.xsd', 10, 8)
    _Documentation = None
