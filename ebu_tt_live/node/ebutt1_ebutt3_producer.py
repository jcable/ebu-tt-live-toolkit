...
class EBUTT1EBUTT3ProducerNode(AbstractCombinedNode):
    ...
    def __init__(self, node_id, consumer_carriage=None, producer_carriage=None, 
        sequence_identifier=None, use_document_identifier_as_sequence_identifier=True, **kwargs):
        ...
        self._ebutt3_converter = EBUTT1EBUTT3Converter(sequence_id=sequence_identifier,
